...
export const Profile = () => {
  return (
    <div className='max-w-[1240px] group mx-auto px-4 md:px-16 bg-[#094519] text-white mt-16 pt-16 sm:rounded-xl'>
    <div className='flex grid md:grid-cols-3 gap-16'>
        ...
        <img className='w-fill rounded-xl'src='https://images.unsplash.com/photo-1631248055158-edec7a3c072b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1161&q=80' alt='/'/>
        </div>
