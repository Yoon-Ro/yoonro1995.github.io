...
const Hero = () => {
  ...
  return (
    <div className='max-w-screen  mx-auto' id='hero' >
...
{/* BURGER IMAGE */}
            <img className="rounded-xl w-screen h-screen object-cover"src="https://images.unsplash.com/photo-1635201848404-7a858102f3ac?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt='hamburger'/>
        </div>
