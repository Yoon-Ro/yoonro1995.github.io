...
import GPASD3 from './indoor/down/GPASD3';
import GPASD4 from './indoor/down/GPASD4';
...
const GP_ASD3 = () => {
    ...
    return (
        ...
        <div className='w-fill h-fill md:h-screen mx-auto flex flex-col justify-center items-center max-w-[1920px]'>
          ...
          <li className='px-4 py-2 bg-[#d3ffb6] rounded-xl text-black font-bold sticky top-0'>GP-ASD3&4 </li> 
          <Link to="../GP_ASD5"><li className='px-4 py-2 '>GP-ASD5&6</li> </Link>
    ...
    {/* BUTTON */}
          ...
          <span className='px-4 font-bold text-[#5dda4d]/60  text-md '><Link to="../GP_ASD5">NEXT</Link></span>
          </button>
