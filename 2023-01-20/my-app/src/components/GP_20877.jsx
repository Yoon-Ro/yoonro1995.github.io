...
export const GP_20877 = () => {

  const navigate = useNavigate();

  return (

    <div className='md:h-screen md:relative max-w-screen  mx-auto bg-black/40 rounded-xl px-4' id='gp_20877'>
            {/* OVERLAY */}
    ...
    <div className='w-fill md:h-screen mx-auto flex flex-col justify-center items-center max-w-[1920px]'>
        ...
        <ul className='text-md mt-4'>
          ...
          <li className='px-4 py-2 bg-[#bfffb6] rounded-t-xl text-black font-bold'>GP-20877</li>
          <li className='px-4 py-2 bg-[#bfffb6] rounded-b-xl text-black font-bold'>GP-20878</li>
          <li className='px-4 py-2'>GP-20879</li>
  
        </ul>
        </div>
        <div className='col-span-3 flex flex-col justify-between bg-slate-50/10 rounded-xl'>
        <GP20877 />   
        <GP20878 />   
...
{/* BUTTON */}
      ...
      <span className='px-4 font-bold text-[#5dda4d]/60  text-md '><Link to="../GP_20879">NEXT</Link></span>
      </button>
