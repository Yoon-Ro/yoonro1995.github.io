...
import dummy from '../../../data/GIT_product_data_json/indoor-lighting/led-downlights/gp-asd-series/gp-asd6.json';


export const GPASD6 = () => {
  return (
    // <div  className='grid md:grid-cols-3 gap-4 py-4 bg-slate-50/10 md:px-4 px-2 rounded-3xl h-[80vh]'>
    <div  className='grid md:grid-cols-5 gap-4 py-4 md:px-4 px-2 rounded-3xl md:h-[80vh] h-[100vh]'>
        {dummy.product_info.map((id) => (
            <div key={id}>
            <img className='bg-white rounded-xl col-span-1 ' src='https://www.greenimagetech.com/wp-content/uploads/2019/12/GD-ASD6-2-HD4.png' alt='/'/>
...
{dummy.specifications.map((id) => (
              ...
              <ul key={id} className=' text-white text-xs col-span-2  rounded-xl'>
