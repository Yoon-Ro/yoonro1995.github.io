...
import dummy from '../../../data/GIT_product_data_json/indoor-lighting/led-downlights/gp-bsc-series/gp-bsc3.json';
  ...
  return (
    ...
    <div  className='grid md:grid-cols-4 gap-4 py-4 md:px-4 px-2 rounded-3xl md:h-[80vh] h-[100vh]'>
        {dummy.product_info.map((id) => (
            <div key={id}>
            <img className='bg-white rounded-xl col-span-1 ' src='https://www.greenimagetech.com/wp-content/uploads/2019/12/GP-BSC3-HD.png' alt='/'/>
...
{dummy.specifications.map((id) => (
              ...
              <ul key={id} className=' text-white text-xs col-span-3  rounded-xl'>
