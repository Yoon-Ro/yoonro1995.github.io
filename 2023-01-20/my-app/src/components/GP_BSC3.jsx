...
import GPBSC3 from './indoor/down/GPBSC3';
import GPBSC4 from './indoor/down/GPBSC4';
...
const GP_BSC3 = () => {
    ...
    return (
        ...
        <div className='w-fill h-fill md:h-screen mx-auto flex flex-col justify-center items-center max-w-[1920px]'>
            ...
            <li className='px-4 py-2'>GP-ASD3&4</li>
              <li className='px-4 py-2'>GP-ASD5&6</li>
              <li className='px-4 py-2 bg-[#d3ffb6] rounded-xl text-black font-bold sticky top-0'>GP-BSC3&4</li>
    ...
    {/* BUTTON */}
          ...
          <span className='px-4 font-bold text-[#5dda4d]/60  text-md '><Link to="">NEXT</Link></span>
          </button>
